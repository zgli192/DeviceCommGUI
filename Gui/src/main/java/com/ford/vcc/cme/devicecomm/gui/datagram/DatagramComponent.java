 ...
 * </pre>
 */
public class DatagramComponent extends JPanel{



    public DatagramComponent(ExceptionHandler exceptionHandler, MessageHandler messageHandler, MessageSenderFactory messageSenderFactory){

        setLayout(new BorderLayout());

        JSplitPane splitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, new ClientComponent(exceptionHandler, messageHandler,
                messageSenderFactory),new ClientComponent(exceptionHandler, messageHandler,
